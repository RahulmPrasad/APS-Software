...
export default function InquiryRegister() {
            ...
            <div className="form-wrapper">
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input maxLength="7" type="text" id="jobnumber" name="JobNumber" required />
              </div>

              <div className="form-group">
                <label htmlFor="inquiryDate">Inquiry Date</label>
                <input type="text" id="inquiryDate" name="InquiryDate" required />
              </div>
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input type="text" id="inquirySource" name="InquirySource" required />
              </div> 
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                <label htmlFor="clientRequirement">Client Requirement</label>
                <textarea id="clientRequirement" name="ClientRequirement" rows="3" required></textarea>
              </div>
  ...
  <option value="Zimbabwe">Zimbabwe</option>
              ...
              <div className="form-group">
                <label htmlFor="tentativeDate">Tentative Date of Inspection</label>
                <input type="text" id="tentativeDate" name="TentativeDateOfInspection" />
              </div>
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                ...
                <select id="numberOfDaysUnit" name="NumberOfDaysUnit">
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                ...
                <select id="costCurrency" name="CostCurrency" required>
              ...
              <div className="form-group">
                <label htmlFor="costInINR">Cost in INR</label>
                <input type="number" step="0.01" id="costInINR" name="CostInINR" min="0" />
              </div>
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                <label htmlFor="offeredPriceCurrency">Offered Price Currency</label>
                <select id="offeredPriceCurrency" name="OfferedPriceCurrency" required>
                  <option value="" disabled selected>--Select Currency--</option>
                  <option value="USD">USD</option>
                  <option value="INR">INR</option>
                  <option value="EUR">EUR</option>
              ...
              <div className="form-group">
                ...
                <input type="number" step="0.01" id="offeredPrice" name="OfferedPrice" min="0" required />
              </div>

              <div className="form-group">
                <label htmlFor="offeredPriceInINR">Offered Price in INR</label>
                <input type="number" step="0.01" id="offeredPriceInINR" name="OfferedPriceInINR" min="0" />
              </div>
             ...
             <div className="form-section">
              ...
              <div className="form-group">
                ...
                <input type="text" id="margin" name="Margin" step="0.01" />
              </div>
              ...
              <div className="form-group">
                <label htmlFor="ownerCoordinator">Owner/Coordinator</label>
             ...
             <div className="form-section">
              ...
              <div className="form-group" id="bottom">
